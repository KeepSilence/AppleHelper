...
namespace AppleHelper_Server
{
    ...
    public class ComputerInfoHelper
    {
        ...
        *****************************************************************************************/
        ...
        /// <summary>
        /// 获得特定硬盘信息，返回一个硬盘信息结构HardDiskInfo，
        /// 此结构包括硬盘的出厂型号，驱动版本号，序列号，容量(以M为单位).
        /// </summary>
        /// <param name="driveIndex">待获取的硬盘序号</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="driveIndex">待获取的硬盘序号</param>
        public static string GetHddInfo_ModuleNumber(byte driveIndex)
        {
            switch (Environment.OSVersion.Platform)
            {
                case PlatformID.Win32Windows:
                    return GetHddInfo9x(driveIndex).ModuleNumber;
                case PlatformID.Win32NT:
                    return GetHddInfoNT(driveIndex).ModuleNumber;
                case PlatformID.Win32S:
                    throw new NotSupportedException("Win32s is not supported.");
                case PlatformID.WinCE:
                    throw new NotSupportedException("WinCE is not supported.");
        ...
        /// </summary>
        /// <param name="driveIndex">待获取的硬盘序号</param>
        public static string GetHddInfo_Firmware(byte driveIndex)
        {
            switch (Environment.OSVersion.Platform)
            {
                case PlatformID.Win32Windows:
                    return GetHddInfo9x(driveIndex).Firmware;
                case PlatformID.Win32NT:
                    return GetHddInfoNT(driveIndex).Firmware;
                case PlatformID.Win32S:
                    throw new NotSupportedException("Win32s is not supported.");
                case PlatformID.WinCE:
                    throw new NotSupportedException("WinCE is not supported.");
        ...
        /// </summary>
        /// <param name="driveIndex">待获取的硬盘序号</param>
        public static string GetHddInfo_SerialNumber(byte driveIndex)
        {
            switch (Environment.OSVersion.Platform)
            {
                case PlatformID.Win32Windows:
                    return GetHddInfo9x(driveIndex).SerialNumber;
                case PlatformID.Win32NT:
                    return GetHddInfoNT(driveIndex).SerialNumber;
                case PlatformID.Win32S:
                    throw new NotSupportedException("Win32s is not supported.");
                case PlatformID.WinCE:
                    throw new NotSupportedException("WinCE is not supported.");
        ...
        /// <param name="driveIndex">待获取的硬盘序号</param>
        /// <returns></returns>
        public static uint GetHddInfo_Capacity(byte driveIndex)
        {
            switch (Environment.OSVersion.Platform)
            {
                case PlatformID.Win32Windows:
                    return GetHddInfo9x(driveIndex).Capacity;
                case PlatformID.Win32NT:
                    return GetHddInfoNT(driveIndex).Capacity;
                case PlatformID.Win32S:
                    throw new NotSupportedException("Win32s is not supported.");
                case PlatformID.WinCE:
                    throw new NotSupportedException("WinCE is not supported.");
